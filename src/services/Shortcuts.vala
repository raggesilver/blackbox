...
namespace Terminal {
  ...
  public const string ACTION_WIN_SWITCH_HEADER_BAR_MODE =
  ...
  public const string ACTION_WIN_CLEAR_SCROLLBACK = "win.clear-scrollback";
  ...
  public const string ACTION_SHORTCUT_EDITOR_ADD_KEYBINDING =
    "shortcut-editor.add-keybinding";
  public const string ACTION_SHORTCUT_EDITOR_REMOVE_KEYBINDING =
    "shortcut-editor.remove-keybinding";
  public const string ACTION_SHORTCUT_EDITOR_RESET =
    "shortcut-editor.reset";
  public const string ACTION_SHORTCUT_EDITOR_RESET_ALL =
    "shortcut-editor.reset-all";
}
...
public class Terminal.Keymap : Object, Json.Serializable {
  ...
  construct {
    ...
    _keymap.set(ACTION_NEW_WINDOW, "<Shift><Control>n");
    _keymap.set(ACTION_WIN_SWITCH_HEADER_BAR_MODE, "<Shift><Control>h");
    _keymap.set(ACTION_WIN_NEW_TAB, "<Shift><Control>t");
    _keymap.set(ACTION_WIN_EDIT_PREFERENCES, "<Control>comma");
    _keymap.set(ACTION_WIN_COPY, "<Shift><Control>c");
    _keymap.set(ACTION_WIN_PASTE, "<Shift><Control>v");
    _keymap.set(ACTION_WIN_SEARCH, "<Shift><Control>f");
    _keymap.set(ACTION_WIN_FULLSCREEN, "F11");
    _keymap.set(ACTION_WIN_SHOW_HELP_OVERLAY, "<Shift><Control>question");
    _keymap.set(ACTION_WIN_ZOOM_IN, "<Shift><Control>plus");
    _keymap.set(ACTION_WIN_ZOOM_OUT, "<Control>minus");
    _keymap.set(ACTION_WIN_ZOOM_DEFAULT, "<Shift><Control>parenright");
    _keymap.set(ACTION_WIN_CLOSE_TAB, "<Shift><Control>w");
    _keymap.set(ACTION_WIN_RENAME_TAB, "<Shift><Control>r");
    _keymap.set(ACTION_WIN_MOVE_TAB_LEFT, "<Shift><Control>Page_Up");
    _keymap.set(ACTION_WIN_MOVE_TAB_RIGHT, "<Shift><Control>Page_Down");
    _keymap.set(ACTION_WIN_CLEAR_SCROLLBACK, "<Control>k");

    _keymap.set(ACTION_WIN_SWITCH_TAB_1, "<Alt>1");
    _keymap.set(ACTION_WIN_SWITCH_TAB_2, "<Alt>2");
    _keymap.set(ACTION_WIN_SWITCH_TAB_3, "<Alt>3");
    _keymap.set(ACTION_WIN_SWITCH_TAB_4, "<Alt>4");
    _keymap.set(ACTION_WIN_SWITCH_TAB_5, "<Alt>5");
    _keymap.set(ACTION_WIN_SWITCH_TAB_6, "<Alt>6");
    _keymap.set(ACTION_WIN_SWITCH_TAB_7, "<Alt>7");
    ...
    if (accel == null) {
      ...
      if (current_accel_action != null) {
        if (
          ...
          debug(
            "Keybinding was already in use. User chose to keep old binding.");
          return false;
        }
      }
      this.keymap.@set(action, accel);

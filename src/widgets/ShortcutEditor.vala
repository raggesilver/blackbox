...
public class Terminal.ShortcutEditor : Adw.PreferencesPage {
  ...
  static construct {
    ...
    action_map.@set(ACTION_WIN_CLEAR_SCROLLBACK, _("Reset and Clear"));
  ...
  async void request_reset_all() {
    Adw.AlertDialog dlg = new Adw.AlertDialog(
      ...
      _(
        "This will reset all shortcuts to default and overwrite your config file. This action is irreversible."));
